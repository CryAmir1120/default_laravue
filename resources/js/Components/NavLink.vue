...
const classes = computed(() =>
    props.active
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-indigo-400 dark:border-indigo-600 text-sm font-medium leading-5 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out text-16'
...
<template>
    <Link :href="href" :class="classes" class="nav-link">
        <slot />
    </Link>
</template>
